        ...
        {signals.slice(0, 5).map((s, i) => (
          <div key={s.ticker} className="bg-gray-800 rounded-lg p-3">
            ...
            <div className="flex gap-2 text-xs">
              <span className="text-gray-400">M:{(s.momentum_score * 100).toFixed(0)}%</span>
              <span className="text-gray-400">Q:{(s.quality_score * 100).toFixed(0)}%</span>
              <span className="text-gray-400">V:{(s.value_score * 100).toFixed(0)}%</span>
              <span className="text-gray-400">LV:{(s.low_vol_score * 100).toFixed(0)}%</span>
